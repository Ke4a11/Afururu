...
//        Hotel_Claim.add("");
    ...
    public static LinkedHashMap<String, List<String>> getschoolInfo() {
        ...
        List<String> schoolaisatu = new ArrayList<String>();

        schoolaisatu.add("とてもいい");
        schoolaisatu.add("この上なく良い");
        schoolaisatu.add("まあまあ");
        schoolaisatu.add("元気です。ありがとう");
        schoolaisatu.add("悪くない");
        ...
        schoolagain.add("(最後に会った時から)久しぶりね");
        schoolagain.add("懐かしね");
        schoolagain.add("久しぶり");
        schoolagain.add("お久しぶりね!お元気ですか?");


        List<String> schoolbye = new ArrayList<String>();
        schoolbye.add("またあとでね!");
        schoolbye.add("親しい感じの別れ方");
        schoolbye.add("(一時の遠い)さようなら");
        schoolbye.add("また会おうね");
        schoolbye.add("また来週の日曜日ね");
        ...
        shoolDetail.put("久しぶりの再会", schoolagain);
        shoolDetail.put("別れ際の言葉", schoolbye);
        shoolDetail.put("What's up?と聞かれた時", schoolqes);
    ...
    public static LinkedHashMap<String, List<String>> getrestInfo() {
        ...
        rest_check.add("勘定お願いします");
        rest_check.add("クレジットカードで支払えますか？");
        rest_check.add("レシート（領収書）を下さい。");
